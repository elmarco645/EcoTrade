            ...
            <div className="px-8 pb-8">
              ...
              <div className="text-center lg:text-left space-y-4">
                ...
                <div className="flex items-center justify-center lg:justify-start gap-4 pt-2">
                  {socialLinks.twitter && (
                    <a href={`https://twitter.com/${socialLinks.twitter}`} target="_blank" rel="noreferrer" className="text-slate-400 hover:text-blue-400 transition-colors" aria-label="Twitter">
                      <Twitter size={18} />
                    </a>
                  )}
                  {socialLinks.instagram && (
                    <a href={`https://instagram.com/${socialLinks.instagram}`} target="_blank" rel="noreferrer" className="text-slate-400 hover:text-pink-500 transition-colors" aria-label="Instagram">
                      <Instagram size={18} />
                    </a>
                  )}
                  {socialLinks.whatsapp && (
                    <a href={`https://wa.me/${socialLinks.whatsapp.replace(/\D/g, '')}`} target="_blank" rel="noreferrer" className="text-slate-400 hover:text-emerald-500 transition-colors" aria-label="WhatsApp">
                      <MessageSquare size={18} />
                    </a>
                  )}
                  {socialLinks.website && (
                    <a href={socialLinks.website.startsWith('http') ? socialLinks.website : `https://${socialLinks.website}`} target="_blank" rel="noreferrer" className="text-slate-400 hover:text-emerald-500 transition-colors" aria-label="Website">
                      <Globe size={18} />
                    </a>
                  )}
                </div>
                ...
                <div className="pt-4 space-y-3">
                  ...
                  {user.dob && (
                    <div className="flex items-center gap-3 text-sm font-semibold text-slate-600">
                      ...
                      Born {new Date(user.dob).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
                    </div>
                  )}
                  <div className="flex items-center gap-3 text-sm font-semibold text-slate-600">
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              <div className="mb-8 flex items-center justify-between">
                ...
                <button onClick={() => setIsEditing(false)} className="rounded-2xl bg-slate-50 p-2 text-slate-400 hover:bg-red-50 hover:text-red-500 transition-colors" aria-label="Close edit profile">
                  <X size={20} />
                </button>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-6">
                    <div className="space-y-2">
                      <label htmlFor="edit-name" className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Full Name</label>
                      <input 
                        id="edit-name"
                        type="text" 
                        value={editForm.name} 
                    ...
                    <div className="space-y-2">
                      <label htmlFor="edit-username" className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Username</label>
                    ...
                    <div className="space-y-2">
                      <label htmlFor="edit-bio" className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Bio</label>
                      <textarea 
                        id="edit-bio"
                        value={editForm.bio} 
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <label htmlFor="edit-location" className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Location</label>
                      <input 
                        id="edit-location"
                        type="text" 
                    ...
                    <div className="space-y-2">
                      <label htmlFor="edit-dob" className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Date of Birth</label>
                      <input 
                        id="edit-dob"
                        type="date" 
                        value={editForm.dob} 
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              <div className="mb-8 flex items-center justify-between">
                ...
                <button onClick={() => setIsVerifying(false)} className="rounded-2xl bg-slate-50 p-2 text-slate-400 hover:bg-red-50 hover:text-red-500 transition-colors" aria-label="Close verification">
                  <X size={20} />
                </button>
              </div>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              <div className="mb-8 flex items-center justify-between">
                ...
                <button onClick={() => setIsDeleting(false)} className="rounded-2xl bg-slate-50 p-2 text-slate-400 hover:bg-red-50 hover:text-red-500 transition-colors" aria-label="Close delete account">
                  <X size={20} />
                </button>
              </div>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              <div className="mb-8 flex items-center justify-between">
                ...
                <button onClick={() => setIsChangingPassword(false)} className="rounded-2xl bg-slate-50 p-2 text-slate-400 hover:bg-red-50 hover:text-red-500 transition-colors" aria-label="Close change password">
                  <X size={20} />
                </button>
              </div>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              <div className="mb-8 flex items-center justify-between">
                ...
                <button onClick={() => setIsChangingEmail(false)} className="rounded-2xl bg-slate-50 p-2 text-slate-400 hover:bg-red-50 hover:text-red-500 transition-colors" aria-label="Close change email">
                  <X size={20} />
                </button>
              </div>
